...
// Indiana Municipality Pages - Dynamic import
import { IndianaMunicipalityPage } from "@/pages/towns/IndianaMunicipalityPages";
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main>
          <Switch>
            ...
            {/* Indiana Municipality Pages - 568 towns dynamically generated */}
            {INDIANA_MUNICIPALITIES.map((municipality) => (
              <Route 
                key={municipality.slug} 
                path={municipality.url}
              >
                <IndianaMunicipalityPage municipalitySlug={municipality.slug} />
              </Route>
            ))}
