...
export default function EvolutionD6MaxXt4Page() {
  return (
    <VehicleDetailPage
      ...
      description="High-performance 4-passenger vehicle with advanced technology and premium features. The EVOLUTION D6 MAX XT4 represents the pinnacle of electric golf cart performance for Monroe County enthusiasts. Call 1-844-844-6638."
